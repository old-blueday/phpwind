...
B.namespace('editor.insertmusic', function(B){
	...
	<div style="width:320px;">\
		...
		<form name="B_editor_musicForm" class="B_tableA B_mb10">\
			<table width="100%">\
				<tbody><tr>\
					<td width="60">音乐地址</td>\
					<td><input name="url" type="text" class="B_input B_fl" size="35"><a href="#" class="B_helpA"><i>支持Mp3 ra rm wma等音乐格式链接地址<br>示例:http://server/filename.mp3</i></a></td>\
				</tr>\
				<tr>\
					<td>自动播放</td>\
